        ...
        switch (playerchoice) {
            ...
            case "paper":
                if (cpuChoice == 0) {
                    ...
                    results = "CPU chose Paper, Its a tie. You both suck"
                    draw(rock, hpaper, scissors, rock, hpaper, scissors);
                }
                else {
                    //alert("cpu chose Scissors. You lose!")
                    results = "CPU chose Scissors, loser try again!"
